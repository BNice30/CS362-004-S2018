 ...
 * Date: 6/1/2018
 * Description: This program test the isValid function in UrlValidator.java. 
 * I created the randomcode generator. Remainder of code is from Apache.
 *  
 ...
 */
public class UrlValidatorExtraC extends TestCase {

   private final boolean printStatus = false;
   private final boolean printIndex = false;//print index that indicates current scheme,host,port,path, query test were using.

   public UrlValidatorExtraC(String testName) {
      super(testName);
   }
...
//        testIsValid(testUrlPartsOptions, options);
   ...
   public void testIsValid(Object[] testObjects, long allowAllSchemes) {
      ...
      assertTrue(urlVal.isValid("http://www.google.com/"));
      assertTrue(!urlVal.isValid("http://www.google.com/http://www/google.com"));
      ...
      do {
         ...
         for(int i=0; i<testPartsIndex.length;i++) {  
        	     ResultPair[] part = (ResultPair[]) testObjects[i];
        		 n= rand.nextInt(part.length);
        		 testBuffer.append(part[n].item);
        		 expected &=part[n].valid;
          }
   ...
   public static void main(String[] argv) {
	   ...
	   UrlValidatorExtraC fct = new UrlValidatorExtraC("url test");
      fct.setUp();
      fct.testIsValid();
