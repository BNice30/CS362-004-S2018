...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
	return adventurerEffect(state, handPos, currentPlayer, z, drawntreasure, temphand);
			
    case council_room:
	return councilRoomEffect(state, handPos, currentPlayer);
...
int adventurerEffect(struct gameState *state, int handPos, int currentPlayer, int z, int drawntreasure, int temphand[])
{
      int cardDrawn;
    //bug corrected
...
int councilRoomEffect(struct gameState *state, int handPos, int currentPlayer)
{
      //+4 Cards
      int i;
    //bug corrected
